...
class enlistedCog(commands.Cog):
    ...
    async def medals(self, ctx):
        ...
        await ctx.send(embed=whymeEmbed)
        await ctx.send(embed=ruthlessEmbed)
        await ctx.send(embed=builtdifferentEmbed)
        await ctx.send(embed=specsaversEmbed)
        await ctx.send(embed=knucklesEmbed)
        ...
        await ctx.send(embed=redcrossEmbed)
        ...
        await ctx.send(embed=recruitmentmedalEmbed)
        await ctx.send(embed=pubawardsEmbed)
        await ctx.send(embed=xpawardsEmbed)
        await ctx.send(embed=killawardsEmbed)
        await ctx.send(embed=challengeawardsEmbed)
        await ctx.send(embed=medalapplicationEmbed)
        await ctx.send('*All submissions require the following format (please do not ping medals):*\n```**Medal Requested:**\n**Date/Event of Achievement:**\n**Witnesses (if applicable):**\n**Evidence:**\n@Officer Corps```')
