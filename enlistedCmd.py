...
class enlistedCog(commands.Cog):
    ...
    async def medals(self, ctx):
        ...
        await medalsChannel.send(embed=enlistmedalsEmbed)
        ...
        await medalsChannel.send(embed=orderofthelionEmbed)
        await medalsChannel.send(embed=grenadierexperimenteEmbed)
        await medalsChannel.send(embed=fleurdelisEmbed)
        await medalsChannel.send(embed=bombechanceuseEmbed)
        await medalsChannel.send(embed=ticktickboomEmbed)
        await medalsChannel.send(embed=holyhandgrenadesEmbed)
        ...
        await medalsChannel.send(embed=bronzeLionEmbed)
        await medalsChannel.send(embed=silverLionEmbed)
        await medalsChannel.send(embed=goldLionEmbed)
        await medalsChannel.send(embed=dragzHonorEmbed)
        await medalsChannel.send(embed=loneWolfEmbed)
        ...
        await medalsChannel.send(embed=saberSpearsEmbed)
        await medalsChannel.send(embed=thisroundismeEmbed)
        await medalsChannel.send(embed=pikecasualEmbed)
        await medalsChannel.send(embed=offwiththeirsheadsEmbed)
        await medalsChannel.send(embed=yipikeyaEmbed)
        await medalsChannel.send(embed=sixtyninesbaneEmbed)
        await medalsChannel.send(embed=artymedalsEmbed)
        await medalsChannel.send(embed=someassemblyrequiredEmbed)
        await medalsChannel.send(embed=taxcollectorEmbed)
        await medalsChannel.send(embed=ceasefireEmbed)
        await medalsChannel.send(embed=sixtyninesbaneEmbed)
